...
Monorepo containing all services running under the \*.kschoon.me domains built
with: 
+ [TypeScript](https://www.typescriptlang.org/)

[\*.kschoon.me](https://kschoon.me) hosts all manner of things developed
I have/will develop for my own personal use including:
+ **Personal Landing Page** (kschoon.me) - Utilized for advertising who I am,
  the things I do, and any other pertinent information
+ **Airline Check-in Page** (checkin.kschoon.me) - Automated check-in for
  different airlines.
